...
def detect_objects(input_bev_maps, model, configs):
    ...
    with torch.no_grad():
        ...
        # Here the detections are of the form: [batch_size, K, 10]
            detections = post_processing(
                detections=detections, configs=configs)
    ...
    objects = [
        ([1, obj[2] / configs.bev_height * (configs.lim_x[1] -
                                            configs.lim_x[0]), obj[1] / configs.bev_width *
          (configs.lim_y[1] - configs.lim_y[0]) -
            (configs.lim_y[1] - configs.lim_y[0]) / 2, obj[3], obj[4], obj[5] / configs.bev_width *
            (configs.lim_y[1] - configs.lim_y[0]), obj[6] / configs.bev_height *
            (configs.lim_x[1] - configs.lim_x[0]), obj[7]])
